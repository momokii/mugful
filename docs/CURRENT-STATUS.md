...
**Phase:** Todo 6 couple onboarding accepted; local development auth bypass configured; Todo 7 prompt administration is next
...
Start Todo 7 prompt administration after reviewing the Todo 6 acceptance evidence. Do not add privacy-request operations, video, AI, analytics, Redis, or a second activity while building v1. Complete the independent security and stability gate before production use.
