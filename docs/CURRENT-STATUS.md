...
Start Todo 7 prompt administration after reviewing the Todo 6 acceptance evidence. Do not add privacy-request operations, video, AI, analytics, Redis, or a second activity while building v1. Team-mode security review remains unavailable.
